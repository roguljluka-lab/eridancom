<form action="<?php echo esc_url($_SERVER['REQUEST_URI']); ?>" method="post" id="reservation_form">
    ...
    <div class="dc-row">
        <div class="dc-col-12 dc-px-0 dc-shadow">
            ...
            <div class="dc-row">
                <div class="dc-col-12">
                    <div class="payment-type set_bg_color" data-nacin="3" data-iznos-gotovina="<?php echo number_format($putovanje->ukupni_iznos, '2', ',', '.'); ?>" data-iznos-kartice="<?php echo number_format($putovanje->ukupni_iznos_kartica, '2', ',', '.'); ?>">
                    ...
                    <div class="payment-type" data-nacin="1" data-iznos-putovanja="<?php echo number_format($putovanje->ukupni_iznos, '2', ',', '.'); ?>" data-za-naplatu="<?php echo number_format($putovanje->akontacija, '2', ',', '.'); ?>">
            ...
            <div class="dc-row dc-my-4 dc-mt-3">
                <div class="dc-col-12 dc-mt-3">
                    <input type="checkbox" id="privola_1" name="privola_1" class="validate">
                    <label for="privola_1" style="display: inline; padding-left: 15px;">Dajem privolu na obradu osobnih podataka u svrhu izvršenja usluge koju naručujem. *</label>
                </div>
                <div class="dc-col-12">
                    <input type="checkbox" id="privola_3" name="privola_3" class="validate">
                    <label for="privola_3" style="display: inline; padding-left: 15px;">Pročitao/la sam i slažem se sa <a href="https://eridan.hr/opci-uvjeti/" target="_blank">općim uvjetima korištenja</a> web stranice eridan.hr. *</label>
                </div>
                <div class="dc-col-12 dc-mb-3">
                    <input type="checkbox" id="privola_2" name="privola_2">
                    <label for="privola_2" style="display: inline; padding-left: 15px;">Suglasan sam da se foto/video/audio snimke polaznika mogu koristii u objavama Agencije putem web stranice i društvenih mreža.</label>
                </div>
            </div>
