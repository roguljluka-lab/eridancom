    ...
    <div class="dc-row">
        <div class="dc-col-12 dc-px-0 dc-shadow">
            ...
            <div class="dc-row dc-mt-4">
                ...
                <div class="dc-col-6">
                    <div class="dc-mb-3">
                        <label for="oib_glavni" class="dc-label">OIB *</label>
                        <input type="text" name="oib_glavni" value="<?php echo isset($dc_first_step_data) ? $dc_first_step_data['oib_glavni'] : ''; ?>" class="dc-form-control validate" id="oib_glavni" placeholder="" style="letter-spacing: 2px">
                    </div>
                </div>
                <div class="dc-col-6">
                    <div class="dc-mb-3">
            ...
            <div class="dc-row">
                ...
                <div class="dc-col-6">
                    <div class="dc-mb-3">
                        ...
                        <input type="text" name="ime_dodatni" value="<?php echo isset($dc_first_step_data) ? $dc_first_step_data['ime_dodatni'] : ''; ?>" class="dc-form-control validate" id="ime_dodatni" placeholder="">
                    </div>
                </div>
                <div class="dc-col-6">
                    <div class="dc-mb-3">
                        <label for="prezime_dodatni" class="dc-label">Prezime *</label>
                        <input type="text" name="prezime_dodatni" value="<?php echo isset($dc_first_step_data) ? $dc_first_step_data['prezime_dodatni'] : ''; ?>" class="dc-form-control validate" id="prezime_dodatni" placeholder="">
                    </div>
                </div>
                <div class="dc-col-6">
                    <div class="dc-mb-3">
                        <label for="oib_dodatni" class="dc-label">OIB *</label>
                        <input type="text" name="oib_dodatni" value="<?php echo isset($dc_first_step_data) ? $dc_first_step_data['oib_dodatni'] : ''; ?>" class="dc-form-control validate" id="oib_dodatni" placeholder="" style="letter-spacing: 2px">
                    </div>
                </div>
                <div class="dc-col-6">
                    <div class="dc-mb-3">
                        <label for="rodenje_dodatni" class="dc-label">Datum rođenja *</label>
                        <input type="text" name="rodenje_dodatni" value="<?php echo isset($dc_first_step_data) ? $dc_first_step_data['rodenje_dodatni'] : ''; ?>" class="dc-form-control validate" id="rodenje_dodatni" placeholder="dd.mm.yyyy." style="letter-spacing: 2px">
                    </div>
                </div>
