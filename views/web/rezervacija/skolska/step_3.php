<form action="<?php echo esc_url($_SERVER['REQUEST_URI']); ?>" method="post" id="reservation_form">
    ...
    <input type="hidden" name="nacin_placanja" id="nacin_placanja" value="1">
    <input type="hidden" name="ukupni_iznos_putovanja" id="ukupni_iznos_putovanja" value="<?php echo number_format($putovanje->ukupni_iznos, '2', '.', ''); ?>">
    <input type="hidden" id="totalAdditionals" value="0">
    <input type="hidden" id="totalPassengers" value="2">
    <div class="dc-row">
        <div class="dc-col-12 dc-px-0 dc-shadow">
            ...
            <div class="dc-row">
                <div class="dc-col-12">
                    <div class="payment-type set_bg_color" data-nacin="1" data-iznos-putovanja="<?php echo number_format($putovanje->ukupni_iznos, '2', '.', ''); ?>" data-za-naplatu="<?php echo number_format($putovanje->akontacija, '2', '.', ''); ?>">
                        <div class="payment-title selected">
                            ...
                            <span class="title">INTERNET BANKARSTVOM - PRVA RATA KAO POTVRDA</span>
                        </div>
                        <div class="payment-desc dc-small">
                            Plaćanje prve rate putem internet bankarstva ili općom uplatnicom na osnovi ponude koju ćete dobiti na e-mail u potvrdi ove rezervacije.
                        </div>
                    </div>
                    <div class="payment-type" data-nacin="3" data-iznos-gotovina="<?php echo number_format($putovanje->ukupni_iznos, '2', '.', ''); ?>" data-iznos-kartice="<?php echo number_format($putovanje->ukupni_iznos_kartica, '2', '.', ''); ?>">
                        <div class="payment-title">
                            ...
                            <span class="title">KARTICOM</span>
                        </div>
                        <div class="payment-desc">
                            <p class="dc-small" style="padding-top: 0; margin-top: 0;">
                                Plaćanje karticom putem našeg webshopa jednokratno ili na rate. Uplata se izvršava odmah, a nakon toga ćete na svoj e-mail dobiti ugovor i potvrdu o rezervaciji putovanja.
                            </p>

                            <!--div class="dc-row dc_rate_selector" style="padding: 0; display: none;">
                    ...
                    <!--div class="payment-type" data-nacin="2" data-iznos-putovanja="<?php echo number_format($putovanje->ukupni_iznos, '2', '.', ''); ?>" data-za-naplatu="<?php echo number_format($putovanje->akontacija, '2', '.', ''); ?>">
                        <div class="payment-title">
							<span class="icon dc-icon-nonselected">
								<svg width="30px" height="30px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
									<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <!--div class="payment-type" data-nacin="4" data-iznos-putovanja="<?php echo number_format($putovanje->ukupni_iznos, '2', '.', ''); ?>" data-za-naplatu="<?php echo number_format($putovanje->ukupni_iznos, '2', '.', ''); ?>">
                        <div class="payment-title">
							<span class="icon dc-icon-nonselected">
								<svg width="30px" height="30px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
									<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        ...
                        <div class="payment-desc dc-small">
                            Plaćanje se vrši gotovinom ili karticama (jednokratno ili na rate), osobnim dolaskom u agenciju.
                        </div>
                    </div-->
                </div>
            </div>
                    ...
                    <div class="dc-summary">
                        <table style="width: 100%; line-height: 1.5;">
                            ...
                            <tr>
                                ...
                                <td class="dc-end total"><span class="dc_iznos_putovanja"><?php echo number_format($putovanje->ukupni_iznos, '2', '.', ''); ?> €</span></td>
                            </tr>
                            <tr>
                                <th class="dc-end"><strong>ZA NAPLATU</strong></th>
                                <th class="dc-end total_za_naplatu"><strong><span class="dc_za_naplatu"><?php echo number_format($putovanje->akontacija, '2', '.', ''); ?> €</span></strong></th>
                            </tr>
                            </tbody>
                        </table>
                    </div>
            ...
            <div class="dc-row dc-my-4 dc-mt-3">
                ...
                <div class="dc-col-12">
                    <label class="dc-chck-custom-checkbox" for="privola_2">
                        <input type="checkbox" id="privola_2">
                        <span class="dc-chck-checkmark"></span>
                        <span class="dc-chck-label-text">Suglasan sam da se foto/video/audio snimke polaznika mogu koristiti u objavama Agencije putem web stranice i društvenih mreža.</span>
                    </label>
                </div>
            </div>
