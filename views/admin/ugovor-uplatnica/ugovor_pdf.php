...
<tr>
	...
	<tr>
		...
		<td colspan="5" style="line-height: 15px;">
		<b>Šifra aranžmana:</b> ' . $parameters['sifra'] . '<br>
		<b>Škola i razred:</b> ' . $parameters['dc_naziv_skole'] . ', ' . $parameters['dc_razred'] . '
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td colspan="5" style="line-height: 15px;">
		<b>PUTNIK:</b><br>
		<b>Ime i prezime:</b> ' . $dc_first_step_data['ime_putnika'] . ' ' . $dc_first_step_data['prezime_putnika'] . '<br>
		<b>OIB:</b> ' . $dc_first_step_data['oib_putnika'] . '<br>
		<b>Datum rođenja:</b> ' . $dc_first_step_data['rodenje_putnika'] . '<br>
		<b>Kontakt broj:</b> ' . $dc_first_step_data['kontakt_putnika'] . '<br>
		<b>Adresa stanovanja:</b> ' . $dc_first_step_data['adresa_putnika'] . '<br>
		<b>Mjesto:</b> ' . $dc_first_step_data['postanski_putnika'] . ' ' . $dc_first_step_data['mjesto_putnika'] . '<br>
		</td>
		<td colspan="5">
		<b>UGOVARATELJ:</b><br>
		<b>Ime i prezime:</b> ' . $dc_first_step_data['ime_ugovaratelja'] . ' ' . $dc_first_step_data['prezime_ugovaratelja'] . '<br>
		<b>Kontakt broj:</b> ' . $dc_first_step_data['kontakt_ugovaratelja'] . '<br>
		<b>Email adresa:</b> ' . $dc_first_step_data['email_ugovaratelja'] . '<br><br>
		</td>
	</tr>
	<tr>
	...
	<td colspan="10">
        ...
        <p>Sukladno Zakonu o provedbi Opće uredbe o zaštiti podataka ( N.N. 42/18 ) i čl.  30. Opće uredbe o zaštiti osobnih podataka suglasan sam da putnička agencija Eridan d.o.o.  , Fuležina 12, 21216 Kaštel Stari, OIB: 63978810525 , obrađuje osobne podate, ime i prezime, datum rođenja , po potrebi : broj osobne iskaznice / putovnice ,  OIB i adresu putnika i zakonskog zastupnika  u svrhu realizacije ugovorenog paket aranžmana prema prihvaćenom programu te ih prosljeđuje Trećim osobama.<br><br>
Suglasan sam da se fotografije / video snimke/ audio snimke mog djeteta sa putovanja mogu objaviti na društvenim mrežama Agencije.<br><br>
Učenik će sudjelovat na putovanju, kao roditelj/staratelj upoznat/a sam s općim uvjetima putničke agencije Eridan.<br><br>
Roditelj – staratelj maloljetnika može u svako doba zatražiti opoziv.</p>
    </td>
</tr>
<tr>
