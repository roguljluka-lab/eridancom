        ...
        <div id="postbox-container-2" class="postbox-container dc-admin-col">
            <table class="dc_input_table wp-list-table widefat striped dc_data_table" role="presentation">
                ...
                <tr>
                    <th>Tip putovanja</th>
                    <td>
                        <input type="radio" name="putovanje_type" id="skolska" value="skolska" checked="checked">
                        <label for="skolska">Školska</label>
                    </td>
                    <td>
                        <input type="radio" name="putovanje_type" id="ostala" value="ostala">
                ...
                <tr class="form-field user-language-wrap dc_skolska">
                    <th>
                        <label for="locale">
                            Školska godina
                        </label>
                    ...
                    <td>
                        <select name="skolska_godina" id="skolska_godina" class="select-school-year">
                            ...
                            for ($ssy = $current_year; $ssy <= $current_year + 5; $ssy++) {
                                $selected = (json_decode($putovanje->razredi)[0]->sk_godina == ($ssy - 1) . $ssy) ? 'selected' : '';
                ...
                <tr class="form-field podaci_o_skoli dc_skolska">
                ...
                <tr class="form-field razred_tr dc_skolska <?php echo isset($putovanje->razredi) ? '' : 'style="display: none;'; ?>">
                    <th>
                        <label for="locale">
                            Razredi (npr. 3.A)
                        </label>
                ...
                <tr class="form-field razrednik_tr" <?php echo isset($putovanje) ? '' : 'style="display: none;"'; ?>>
                    <th>
                        <label for="locale">
                            Razrednici
                        </label>
                    </th>
                    <td class="input_razrednici">
                        <?php if(isset($putovanje) && $putovanje->razredi) :
                            foreach(json_decode($putovanje->razredi) as $razred) : ?>
                                <div style="padding-top: 8px;" class="dc_input_razrednici">
                                    <label>Razrednik: <?php echo $razred->naziv; ?></label><br>
                                    <input type="text" placeholder="Razrednik <?php echo $razred->naziv; ?>" name="razrednici[<?php echo $razred->id; ?>]" value="<?php echo $razred->razrednik; ?>">
                                </div>
                                <input type="hidden" class="dc_input_razredi" name="razredi[<?php echo $razred->id; ?>]" value="<?php echo $razred->naziv; ?>">
                ...
                <tr class="dc_ostala">
                    <td colspan="3"><b><center>Fakultativni dodaci ( nije aktivirano )</center></b></td>
                </tr>
                <tr class="form-field dc_ostala">
                    <td>Iznos</td>
                    <td>Naziv</td>
                    <td><span class="button dc_add_new_row" style="float: right;"> + Dodaj novi red</span></td>
                </tr>
                <tr class="form-field dc_ostala dc_clone_row">
                    <td><input class="dc_iznos" name="iznos_dodatka[]" type="text"></td>
                    <td colspan="2"><input name="naziv_dodatka[]" type="text"></td>
                </tr>
                <tr>
                    <td colspan="2">
