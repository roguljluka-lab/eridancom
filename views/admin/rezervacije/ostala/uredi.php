    ...
    <form name="post" action="#" method="post">
        <div id="postbox-container-2" class="postbox-container dc-admin-col">
            ...
            <table class="wp-list-table widefat striped dc_data_table" style="margin-top: 1rem;">
                ...
                <tr>
                    <td colspan="2">
                        <h2 style="margin: 0; text-align: center">GLAVNI PUTNIK <a href="<?php echo admin_url('admin.php?page=dcr-putnici&action=uredi&id=' . $rezervacija->ugovaratelj_id); ?>" class="dc-edit-button" style="float: right">Promijeni</a></h2>
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <?php echo $rezervacija->ugovaratelj_adresa . '<br>' . $rezervacija->ugovaratelj_pb . ' ' . $rezervacija->ugovaratelj_mjesto; ?>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <?php echo $rezervacija->ugovaratelj_rodendan; ?>
                    </td>
                </tr>
                <tr>
                    <td colspan="2">
                        <h2 style="margin: 0; text-align: center"">DODATNI PUTNIK <a href="<?php echo admin_url('admin.php?page=dcr-putnici&action=uredi&id=' . $rezervacija->putnik_id); ?>" class="dc-edit-button" style="float: right">Promijeni</a></h2>
                    </td>
                </tr>
                <tr>
                    <td>
            ...
            <table class="wp-list-table widefat striped dc_data_table dc_payments" style="margin-top: 1rem;">
                ...
                if(count($payments) > 0) : ?>
                    ...
                    <tr>
                        ...
                        <td style="text-align: right; font-weight: 700;"><?php echo number_format($total_paid, 2); ?> €</td>
                    </tr>
                    <tr>
                        ...
                        <td style="text-align: right; font-weight: 700;"><?php echo number_format($preostali_iznos, 2); ?> €</td>
                    </tr>
                <?php else : ?>
                    <tr>
